...
#./compile.sh build BOARD=yjh-jm10-3588 BRANCH=vendor BUILD_DESKTOP=no BUILD_MINIMAL=yes  KERNEL_CONFIGURE=no RELEASE=noble DOWNLOAD_MIRROR=china MAINLINE_MIRROR=tuna GITHUB_MIRROR=ghproxy


# 根据 DSA 开关动态选择设备树文件
if [[ ${JM10_DSA_88E6390} = "yes" ]]; then
	BOOT_FDT_FILE="rockchip/rk3588-yjh-jm10-dsa.dtb"
else
